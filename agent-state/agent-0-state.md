...
- ❌ P7B Meeting Intelligence — not started (next major module).
- ⚠️ P1/P2 research + architecture docs — partial; `/reference/` assets missing.
- `develop` integration branch created at ec53c5d.
...
## Next actions
1. P7B Meeting Intelligence: schema + schedule UI + mock analysis pipeline (no real capture yet).
